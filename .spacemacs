...
layers configuration."
  (setenv "PATH" (concat (getenv "PATH") ":/home/neo/.npm-packages/bin/"))
  (setq exec-path (append exec-path '(":/home/neo/.npm-packages/bin/")))
  ...
  (global-set-key (kbd "<f6>") 'cleanup-buffer)
...
(custom-set-faces
 ...
 '(mode-line-inactive ((t (:foreground "#b2b2b2"))))
 '(powerline-active1 ((t (:family "Ubuntu Mono"))))
 '(powerline-active2 ((t (:family "Ubuntu Mono")))))
